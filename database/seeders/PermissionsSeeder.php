...
class PermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به مدیر گروه', 'guard_name' => 'web'],
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به عضو گروه', 'guard_name' => 'web'],
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به مدیر پژوهش', 'guard_name' => 'web'],
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به مدیر نشر داخلی', 'guard_name' => 'web'],
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به معاون', 'guard_name' => 'web'],
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به ویراستار', 'guard_name' => 'web'],
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به طراح', 'guard_name' => 'web'],
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به صفحه آرا', 'guard_name' => 'web'],

            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی عضو گروه به مدیر گروه', 'guard_name' => 'web'],

            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی مدیر گروه به مدیر پژوهش', 'guard_name' => 'web'],
            ['name' => 'نشر داخلی - نمایش تاریخچه - ارسالی مدیر گروه به عضو گروه', 'guard_name' => 'web'],
