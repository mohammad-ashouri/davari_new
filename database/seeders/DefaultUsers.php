...
class DefaultUsers extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $createRole->givePermissionTo([
            ...
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به مدیر گروه',
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به عضو گروه',
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به مدیر پژوهش',
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به مدیر نشر داخلی',
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به معاون',
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به ویراستار',
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به صفحه آرا',
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین به طراح',
