...
class DefaultUsers extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $createRole->givePermissionTo([
            ...
            'نشر داخلی - نمایش تاریخچه - ارسالی عضو گروه به مدیر گروه',
            'نشر داخلی - نمایش تاریخچه - ارسالی مدیر گروه به مدیر پژوهش',
            'نشر داخلی - نمایش تاریخچه - ارسالی مدیر گروه به عضو گروه',
            ...
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین کل به مدیر گروه',
            'نشر داخلی - نمایش تاریخچه - ارسالی ادمین کل به عضو گروه',
