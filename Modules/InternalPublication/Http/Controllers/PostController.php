...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($post and $path and $file) {
            return redirect()->route('internal-publication.posts.index')->with('success', 'اثر با موفقیت ایجاد شد.');
        }
        $post->delete();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($post) {
            return redirect()->route('internal-publication.posts.index')->with('success', 'اثر با موفقیت ویرایش شد.');
        }
